...
def send_feedback_email(recipient_email: str, topic: str, feedback_html: str):
    """Sends the feedback report to the user via email."""
    ...
    html = f"""
        ...
        ">
            <!-- Header --> 
            <div style="background-color: #212529; padding: 20px 30px;">
                <h1 style="color: #ffffff; margin:0; font-size: 20px;">📊 KA Learning Feedback Report</h1>
            </div>

            <!-- Meta Info -->
            <div style="background-color: #f8f9fa; padding: 12px 30px; border-bottom: 1px solid #dee2e6;">
            ...
            <!-- Feedback Content -->
            <div style="padding: 30px; font-size: 14px; color: #212529; line-height: 1.6;">
                {feedback_html}
            </div>
            ...
            <div style="
                ...
                ">
                <p style="color: #6c757d; font-size:12px; margin:0;"> 
                    This report was generated by analysing your complete response history.
                </p>
                <p style="color: #adb5bd; font-size:11px; margin:5px 0 0 0;"> 
                    KA Project · Built with Google Gemini + Flask + SQLite
                </p>
    ...
    msg = MIMEMultipart("alternative")
    msg["Subject"] = f"KA Feedback Report — {topic}"
    msg["From"] = GMAIL_USER
    ...
    try:
        ...
        print(f"Failed to send feedback email to {recipient_email}: {e}")
        return False
